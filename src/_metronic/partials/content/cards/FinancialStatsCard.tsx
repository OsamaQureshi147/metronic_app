...
export interface FinancialStatsCardProps {
  icon: 'projects' | 'qty' | 'value' | 'apex' | 'opex' | 'saving'
  amount: string
  title: string
  status: 'up' | 'down'
  statusValue: number
...
const renderCardIcon = (iconType: Pick<FinancialStatsCardProps, 'icon'>) => {
      ...
      <div className='card h-lg-100'>
        <div className='card-body d-flex justify-content-between align-items-start flex-column'>
          ...
          <div className='d-flex flex-column my-7'>
            <span className='fw-bold fs-3x text-gray-800 lh-1 ls-n2'>{amount}</span>
            <div className='m-0'>
              <span className='fw-bold fs-6 text-gray-400'>{title}</span>
            </div>
          </div>
          <span className={`badge ${status === 'up' ? 'badge-success' : 'badge-danger'} fs-base`}>
